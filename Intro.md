...
|키|설명|위치|
|--|--|--|
|게임 패드|게임 패드로 캐릭터를 조작하며 손가락으로 터치한 곳에 탄막이 일정한 가속도로 발사된다.
마찰력은 존재하지 않으며 ```라이프 타임``` 이후 소멸된다.|왼쪽 하단|
|스킬 버튼 1|마지막으로 등록된 스킬 사용|오른쪽 하단|
|스킬 버튼 2|마지막으로 등록된 스킬 사용|오른쪽 하단|
|아이템 버튼|등록된 아이템 사용|오른쪽 하단|
|메뉴 버튼|오른쪽 상단|
